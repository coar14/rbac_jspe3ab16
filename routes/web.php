...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/admin/edit-user-permissions/{id}', [AdminController::class, 'editUserPermissions'])->name('admin.editUserPermissions')->middleware('role:admin');
    Route::put('/admin/update-user-permissions/{id}', [AdminController::class, 'updateUserPermissions'])->name('admin.updateUserPermissions')->middleware('role:admin');
    Route::put('/admin/update-user-roles/{id}', [AdminController::class, 'updateUserRoles'])->name('admin.updateUserRoles')->middleware('role:admin');
    Route::delete('/admin/delete-user/{id}', [AdminController::class, 'deleteUser'])->name('admin.deleteUser')->middleware('role:admin');
